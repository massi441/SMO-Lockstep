...
internal interface IPendingPacketStore
{
    ...
    public Result<Error> UploadPacket(PendingPacketRequest uploadRequest);
    ...
    /// <returns>The removed <see cref="PendingPacket"/>, or null if no packet with that sequence number exists.</returns>
